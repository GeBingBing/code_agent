...
_PLAN_APPROVAL_WORDS = frozenset(
    {
        ...
        "run it",
        "looks good",
        # Chinese — only unambiguous multi-char approvals. Single chars
        # like 好/对/行/需要 are too broad (a user saying "需要" to mean
        # "yes I need that" would be misread as plan approval).
        "好的",
        "可以",
        "确认",
        "执行",
