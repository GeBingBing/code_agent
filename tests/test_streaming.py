...
class TestStreamingChat:
    ...
    def test_streaming_returns_generator(self, monkeypatch):
        ...
        async def run():
            return await c.chat(messages=[Message(role="user", content="hi")], stream=True)
    ...
    def test_non_streaming_returns_content(self, monkeypatch):
        ...
        async def run():
            return await c.chat(messages=[Message(role="user", content="hi")], stream=False)
